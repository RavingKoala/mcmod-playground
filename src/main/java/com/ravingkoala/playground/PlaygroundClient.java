...
public class PlaygroundClient {
    public PlaygroundClient(ModContainer container) {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        Playground.LOGGER.info("HELLO FROM CLIENT SETUP");
        Playground.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
